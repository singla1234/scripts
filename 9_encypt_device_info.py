...
dc_in_filename = raw_input('Input CSV filename (device-creds) :  ') or 'device-creds'
key = raw_input('Encryption key (lovely) :  ') or 'lovely'
...
encrypted_dc_out_filename = raw_input('Output encrypted filename (encrypted-device-creds):  ') or 'encrypted-device-creds'
...
print('--- confirm: device_creds json in ---')
